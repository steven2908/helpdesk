<x-app-layout>
    ...
    <style>
        ...
        .btn-dark { background-color: #1f2937; color: white; border: 2px solid #ef4444; text-decoration: none; }
        .btn-red { background-color: #dc2626; color: white; margin-top: 0.5rem; padding: 0.25rem 0.75rem; }
        .btn-red.small { font-size: 0.85rem; }
        ...
        @media (max-width: 768px) {
            ...
            label, select, textarea, input[type="file"] { font-size: 0.95rem; }
            .btn-green, .btn-blue, .btn-dark { width: 100%; padding: 0.75rem; font-size: 1rem; }
        }
    </style>
